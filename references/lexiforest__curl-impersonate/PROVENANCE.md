...
Fetched 2026-08-30T12:07:41Z by `scripts/common/mine-repo.sh`.

| | |
| --- | --- |
| commit | `8d0c2c904c4f3751705d0ede8c28873116309fd2` |
| route | proxy |
...
- `AGENTS.md`: ⛔ an agent instruction file, removed for the reason `docs/methodology/vendoring.md` gives. It is data about somebody else's process and nothing here needs it.
