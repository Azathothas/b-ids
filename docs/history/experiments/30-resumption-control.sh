...
# not to issue session tickets, and scripts/capture/profile.sh passes that
...
#
# Usage:
#   sh docs/history/experiments/30-resumption-control.sh
#   sh docs/history/experiments/30-resumption-control.sh --headless
#   sh docs/history/experiments/30-resumption-control.sh --rounds 5
#
