...
it back. Record what you would have pushed, in the record, and let the
operator act.
...
⚠ **The templates a contributor sees are under `.github/`**, and they are part
of this convention rather than decoration: the pull request form at
[`../../.github/PULL_REQUEST_TEMPLATE.md`](../../.github/PULL_REQUEST_TEMPLATE.md)
asks for the evidence a reviewer needs, and the issue forms ask for what a
report has to carry to be actionable.
