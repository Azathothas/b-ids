...
⚠ **A sweep of another project does NOT go here in this repository**, and that
is a deliberate departure from the shape above.
...
The character set and the marker density apply here as everywhere, held by
`scripts/common/check-markers.sh`, which reads this directory like any other.
The banned vocabulary is `scripts/common/check-docs.sh`, and it reads it too.
