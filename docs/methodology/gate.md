...
If a part cannot pass, that is a **finding recorded in the entry**, not a
...
- the entry is closed, with its acceptance command run, the driven-pass log
