...
## What a session boundary still owes

The entry itself carries the closure evidence, so nothing per-item is written
separately. What still has to exist at every session boundary:
